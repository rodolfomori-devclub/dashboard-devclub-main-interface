...
const PodiumTopSellers = ({ sellers, onSellerClick }) => {
  ...
  return (
    <div className="mb-32 relative overflow-visible">
      ...
      <div className="relative flex justify-center items-end h-130 w-full overflow-visible">
        {/* Segundo Lugar */}
        {podiumOrder[0] && (
          <div 
            onClick={() => onSellerClick(podiumOrder[0])}
            className="relative z-10 flex-1 mx-3 mb-8 max-w-sm cursor-pointer group transform transition-all hover:scale-105 podium-second"
          >
            ...
            <div className="relative h-72 bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border-4 border-gray-300 dark:border-gray-500 z-20">
              ...
              <div className="absolute top-24 inset-x-0 bottom-0 bg-white dark:bg-gray-800 p-4 flex flex-col justify-between">
                <div>
                  <div className="rounded-full h-16 w-16 bg-gray-100 dark:bg-gray-700 flex items-center justify-center mx-auto mb-4">
                    <span className="text-3xl font-bold text-gray-400">{podiumOrder[0].name.charAt(0)}</span>
                  </div>
                  <h3 className="text-xl font-bold text-center text-text-light dark:text-text-dark mb-2">
                    {podiumOrder[0].name}
                  </h3>
                </div>
                
                <div className="text-center mt-6 mb-4">
                  <p className="flex items-center justify-center text-gray-500 dark:text-gray-400 mb-1">
        ...
        {podiumOrder[1] && (
          <div 
            ...
            className="relative z-20 flex-1 mx-3 mb-0 max-w-sm scale-110 cursor-pointer group transform transition-all hover:scale-115 podium-first"
          >
            ...
            <div style={{height:'26rem'}} className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden border-4 border-yellow-400 dark:border-yellow-600 z-20">
              ...
              <div className="absolute top-28 inset-x-0 bottom-0 bg-white dark:bg-gray-800 p-4 flex flex-col justify-between">
                <div>
                  <div className="rounded-full h-20 w-20 bg-yellow-100 dark:bg-yellow-900 flex items-center justify-center mx-auto mb-4 border-2 border-yellow-300">
                ...
                <div className="text-center mt-6 mb-6">
                  <p className="flex items-center justify-center text-yellow-600 dark:text-yellow-400 mb-2">
        ...
        {podiumOrder[2] && (
          <div 
            ...
            className="relative z-10 flex-1 mx-3 mb-20 max-w-sm cursor-pointer group transform transition-all hover:scale-105 podium-third"
          >
            ...
            <div className="relative h-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border-4 border-amber-600 dark:border-amber-800 z-20">
              ...
              <div className="absolute top-20 inset-x-0 bottom-0 bg-white dark:bg-gray-800 p-4 flex flex-col justify-between">
                <div>
                  <div className="rounded-full h-14 w-14 bg-amber-100 dark:bg-amber-900 flex items-center justify-center mx-auto mb-3">
                    <span className="text-2xl font-bold text-amber-600">{podiumOrder[2].name.charAt(0)}</span>
                  </div>
                  <h3 className="text-lg font-bold text-center text-text-light dark:text-text-dark mb-2">
                    {podiumOrder[2].name}
                  </h3>
                </div>
                
                <div className="text-center mt-4 mb-3">
                  <p className="flex items-center justify-center text-amber-700 dark:text-amber-400 mb-1">
                    <FaStar className="mr-1 text-amber-600" /> {podiumOrder[2].totalSales} vendas
                  </p>
                  <p className="text-xl font-bold text-amber-700 dark:text-amber-400 mb-2">
